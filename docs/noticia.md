...
Esse é um curso baseado em projeto, no qual as aulas expositivas e as sessões práticas fornecem a base de conhecimento necessária para a execução do projeto. 

Durante o curso os alunos utilizam o conhecimento adquirido nas sessões expositivas no projeto, que abrange as etapas do processo de FAIRificação, incluindo:
...
Divulgação do curso sobre MODELAGEM CONCEITUAL ORIENTADA POR ONTOLOGIAS, a ser ministrado pelo Prof. Dr. **GIANCARLO GUIZZARDI**, Professor Brasileiro e TITULAR da Universidade de Twente (UT), na Holanda, além de pesquisador reconhecido e autor de mais de 400 artigos na área de modelagem conceitual e ontologias. O Professor GUIZZARDI é o diretor do grupo de pesquisa [Semantics, Cybersecurity and Services](https://www.utwente.nl/en/eemcs/scs/) da UT. Esse grupo vem colaborando com o IME ao longo dos últimos 4 anos no estabelecimento de um intercâmbio institucional entre o IME e a Faculty of Electrical Engineering, Mathematics and Computer Science (FEEMCS). A vinda do Professor GUIZZARDI é apoiada pelo [Projeto S2C2](http://aquarius.ime.eb.br/~s2c2) e pela UFES, e é mais uma atividade do Convênio firmado entre o IME e a FEEMCS da UT.

O curso será oferecido em um formato presencial e compacto, abordando métodos, técnicas e problemas típicos relacionados com a Modelagem Conceptual Orientada por Ontologias, em geral, e OntoUML, em particular. O público alvo do curso são alunos e professores de pós-graduação que tenham interesse no tema modelagem conceitual e ontologias.  Informo ainda que o curso será oferecido nos dias 10, 11 e 13 DEZ 24  das 13h00min às 17h00min, na Seção de Engenharia da Computação (SE/9) situada no 4o andar (fundos) do Instituto Militar de Engenharia.

As vagas são limitadas à capacidade da sala de aula. Prioridade será dada para os alunos de Pós-graduação do IME e da UFRJ que participam dos Projetos [S2C2](http://aquarius.ime.eb.br/~s2c2) e Cibersemântica. A lista de selecionados será divulgada a partir de 1⁠º DEZ 24 no site do Projeto [S2C2](http://aquarius.ime.eb.br/~s2c2). 
...
- relato breve de experiência anterior em modelagem conceitual e ontologias.
