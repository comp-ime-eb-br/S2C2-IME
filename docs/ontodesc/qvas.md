...
[
  {
    ...
    "https://schema.org/name": [
      {
        "@value": "qvas: The Quality Value Assignment Ontology"
      }
    ]
  }
]
  ...
  <body>
    <div id="content">
      <div class="section" id="metadata">
        <h1>qvas: The Quality Value Assignment Ontology</h1>
        <h2>Metadata</h2>
        <dl>
          <div>
            <dt>
          ...
          <div>
            ...
            <dd><p>qvas: The Quality Value Assignment Ontology</p></dd>
          </div>
          <div>
            <dt>
          ...
          <div>
            ...
            <dd>
              <a href="http://purl.org/s2c2/qvas#">http://purl.org/s2c2/qvas#</a>
            </dd>
          </div>
          <div>
            <dt>
            ...
            <dd><p>The Quality Value Assignment ontology (qvas) aims to provide an operational ontology that allows value assignment over time for qualities defined by the UFO foundational ontology. An assigning event can be further specialized as a measurement or a configuration, while a value assignment can be specialized as a measurement result or configuration setting.</p></dd>
          </div>
        </dl>
      </div>
      <div class="section" id="classes">
        <h2>Classes</h2>
        <div class="property entity" id="AAsgnEvent">
          <h3>AAsgnEvent
          ...
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#AAsgnEvent</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>is a specialization of AsgnEvent, representing atomic events of value assignment, which may result in value assignments</p></td>
            </tr>
            <tr>
              <th>
        ...
        <div class="property entity" id="AValueAsgmt">
          <h3>AValueAsgmt
            <sup class="sup-c" title="OWL/RDFS Class">c</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#AValueAsgmt</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>is a specialization of ValueAsgmt, representing atomic value assignments holding a value for MQuality at a specific time.</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subClassOf" title="The subject is a subclass of a class. Defined in The RDF Schema vocabulary (RDFS)">Sub Class Of</a>
        ...
        <div class="property entity" id="AsgnEvent">
          <h3>AsgnEvent
            <sup class="sup-c" title="OWL/RDFS Class">c</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#AsgnEvent</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>is the category of events that assigns values to  MQuality in which an MQBearer and a ValueAssigner participate and possibly lead to a value assignment.</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subClassOf" title="The subject is a subclass of a class. Defined in The RDF Schema vocabulary (RDFS)">Sub Class Of</a>
            ...
            <tr>
              ...
              <td>
                <ul>
                  <li>
                    <span>
                      <a href="https://purl.org/s2c2/qvas#endTime">endTime</a>
                      <sup class="sup-dp" title="OWL Datatype Property">dp</sup>
                    </span>
                  </li>
                  <li>
                    <span>
                      <a href="https://purl.org/s2c2/qvas#startTime">startTime</a>
                      <sup class="sup-dp" title="OWL Datatype Property">dp</sup>
                    </span>
                  </li>
                </ul>
            ...
            <tr>
              ...
              <td>
                <ul>
                  <li>
                    <span>
                      <a href="https://purl.org/s2c2/qvas#hasAEvent">hasAEvent</a>
                      <sup class="sup-op" title="OWL Object Property">op</sup>
                    </span>
                  </li>
                  <li>
                    <span>
                      <a href="https://purl.org/s2c2/qvas#isResultOf">isResultOf</a>
                      <sup class="sup-op" title="OWL Object Property">op</sup>
                    </span>
                  </li>
                  <li>
                    <span>
                      <a href="https://purl.org/s2c2/qvas#participateAsMQB">participateAsMQB</a>
                      <sup class="sup-op" title="OWL Object Property">op</sup>
                    </span>
                  </li>
                  <li>
                    <span>
                      <a href="https://purl.org/s2c2/qvas#participateAsVA">participateAsVA</a>
                      <sup class="sup-op" title="OWL Object Property">op</sup>
                    </span>
                  </li>
                </ul>
        ...
        <div class="property entity" id="CAsgnEvent">
          <h3>CAsgnEvent
            <sup class="sup-c" title="OWL/RDFS Class">c</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#CAsgnEvent</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>is a specialization of AsgnEvent, representing complex events of value assignment as AsgnEvent aggregations</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subClassOf" title="The subject is a subclass of a class. Defined in The RDF Schema vocabulary (RDFS)">Sub Class Of</a>
        ...
        <div class="property entity" id="CValueAsgmt">
          <h3>CValueAsgmt
            <sup class="sup-c" title="OWL/RDFS Class">c</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#CValueAsgmt</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>is a specialization of ValueAsgmt, representing complex value assignments as aggregations of ValueAsgmt.</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subClassOf" title="The subject is a subclass of a class. Defined in The RDF Schema vocabulary (RDFS)">Sub Class Of</a>
            ...
            <tr>
              ...
              <td>
                <ul>
                  <li>
                    <span>
                      <a href="https://purl.org/s2c2/qvas#hasVAsgmt">hasVAsgmt</a>
                      <sup class="sup-op" title="OWL Object Property">op</sup>
                    </span>
                  </li>
                  <li>
                    <span>
                      <a href="https://purl.org/s2c2/qvas#sresultTime">sresultTime</a>
                      <sup class="sup-dp" title="OWL Datatype Property">dp</sup>
                    </span>
                  </li>
                </ul>
        ...
        <div class="property entity" id="DomainEntity">
          <h3>DomainEntity
            <sup class="sup-c" title="OWL/RDFS Class">c</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#DomainEntity</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>an entity in a domain that can be identified as a UFO Object.</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subClassOf" title="The subject is a subclass of a class. Defined in The RDF Schema vocabulary (RDFS)">Sub Class Of</a>
            ...
            <tr>
              ...
              <td>
                <ul>
                  <li>
                    <span>
                      <a href="https://purl.org/s2c2/qvas#MQBearer">MQBearer</a>
                      <sup class="sup-c" title="OWL/RDFS Class">c</sup>
                    </span>
                  </li>
                  <li>
                    <span>
                      <a href="https://purl.org/s2c2/qvas#ValueAssigner">ValueAssigner</a>
                      <sup class="sup-c" title="OWL/RDFS Class">c</sup>
                    </span>
                  </li>
                </ul>
        ...
        <div class="property entity" id="DomainQuality">
          <h3>DomainQuality
            <sup class="sup-c" title="OWL/RDFS Class">c</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#DomainQuality</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>an entity representing an aspect of the domain that can be defined as a UFO Quality.</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subClassOf" title="The subject is a subclass of a class. Defined in The RDF Schema vocabulary (RDFS)">Sub Class Of</a>
            ...
            <tr>
              ...
              <td>
                <span>
                  <a href="https://purl.org/s2c2/qvas#MQuality">MQuality</a>
                  <sup class="sup-c" title="OWL/RDFS Class">c</sup>
                </span>
              </td>
            </tr>
        ...
        <div class="property entity" id="MQBearer">
          <h3>MQBearer
            <sup class="sup-c" title="OWL/RDFS Class">c</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#MQBearer</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>is the role an endurant plays whenever it bears an MQuality while participating in a value assignment event (AsgEvent)</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subClassOf" title="The subject is a subclass of a class. Defined in The RDF Schema vocabulary (RDFS)">Sub Class Of</a>
              ...
              <td>
                <span>
                  <a href="https://purl.org/s2c2/qvas#DomainEntity">DomainEntity</a>
                  <sup class="sup-c" title="OWL/RDFS Class">c</sup>
                </span>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <span>
                  <a href="https://purl.org/s2c2/qvas#describes">describes</a>
                  <sup class="sup-op" title="OWL Object Property">op</sup>
                </span>
              </td>
            </tr>
        ...
        <div class="property entity" id="MQuality">
          <h3>MQuality
            <sup class="sup-c" title="OWL/RDFS Class">c</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#MQuality</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>is the role a quality plays whenever its value changes over time, and it is necessary to keep track of it.</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subClassOf" title="The subject is a subclass of a class. Defined in The RDF Schema vocabulary (RDFS)">Sub Class Of</a>
              ...
              <td>
                <span>
                  <a href="https://purl.org/s2c2/qvas#DomainQuality">DomainQuality</a>
                  <sup class="sup-c" title="OWL/RDFS Class">c</sup>
                </span>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <span>
                  <a href="https://purl.org/s2c2/qvas#holdsValueFor">holdsValueFor</a>
                  <sup class="sup-op" title="OWL Object Property">op</sup>
                </span>
              </td>
            </tr>
        ...
        <div class="property entity" id="ValueAsgmt">
          ...
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#ValueAsgmt</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>is the truthmaker of the material relationship between MQuality and ValueAssigner. It is a category of external dependent modes responsible for holding the assigned value for an MQuality, which a ValueAssigner assigns, and it is the result of a value assignment event in a certain period.</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subClassOf" title="The subject is a subclass of a class. Defined in The RDF Schema vocabulary (RDFS)">Sub Class Of</a>
            ...
            <tr>
              ...
              <td>
                <ul>
                  ...
                  <li>
                    <span>
                      <a href="https://purl.org/s2c2/qvas#isAssignedBy">isAssignedBy</a>
                      <sup class="sup-op" title="OWL Object Property">op</sup>
                    </span>
                  </li>
                  <li>
                  ...
                  <li>
                    <span>
                      <a href="https://purl.org/s2c2/qvas#assignedValue">assignedValue</a>
                      <sup class="sup-dp" title="OWL Datatype Property">dp</sup>
                    </span>
                  </li>
                  <li>
                    <span>
                      <a href="https://purl.org/s2c2/qvas#resultTime">resultTime</a>
                      <sup class="sup-dp" title="OWL Datatype Property">dp</sup>
                    </span>
                  </li>
                </ul>
        ...
        <div class="property entity" id="ValueAssigner">
          <h3>ValueAssigner
            <sup class="sup-c" title="OWL/RDFS Class">c</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#ValueAssigner</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>is the role an endurant plays whenever it is responsible for assigning a value to an MQuality while participating in a value assignment event (AsgEvent)</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subClassOf" title="The subject is a subclass of a class. Defined in The RDF Schema vocabulary (RDFS)">Sub Class Of</a>
      ...
      <div class="section" id="objectproperties">
        ...
        <div class="property entity" id="describes">
          ...
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#describes</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>identifies a MQuality which inheres in a MQBearer</p></td>
            </tr>
            <tr>
              <th>
        ...
        <div class="property entity" id="hasAEvent">
          <h3>hasAEvent
            <sup class="sup-op" title="OWL Object Property">op</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#hasAEvent</code>
              </td>
            </tr>
            <tr>
              <th>
        ...
        <div class="property entity" id="hasVAsgmt">
          <h3>hasVAsgmt
            <sup class="sup-op" title="OWL Object Property">op</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#hasVAsgmt</code>
              </td>
            </tr>
            <tr>
              <th>
        ...
        <div class="property entity" id="holdsValueFor">
          <h3>holdsValueFor
            <sup class="sup-op" title="OWL Object Property">op</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#holdsValueFor</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>identifies a ValueAsgmt which inheres in a MQuality</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subPropertyOf" title="The subject is a subproperty of a property. Defined in The RDF Schema vocabulary (RDFS)">Sub Property Of</a>
        ...
        <div class="property entity" id="isAssignedBy">
          <h3>isAssignedBy
            <sup class="sup-op" title="OWL Object Property">op</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#isAssignedBy</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>identifies a ValueAsgmt which is externally dependent on a ValueAssigner</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subPropertyOf" title="The subject is a subproperty of a property. Defined in The RDF Schema vocabulary (RDFS)">Sub Property Of</a>
        ...
        <div class="property entity" id="isResultOf">
          <h3>isResultOf
            <sup class="sup-op" title="OWL Object Property">op</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#isResultOf</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>identifies a ValueAsgmt that is the result of a value-assigning event</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subPropertyOf" title="The subject is a subproperty of a property. Defined in The RDF Schema vocabulary (RDFS)">Sub Property Of</a>
        ...
        <div class="property entity" id="participateAsMQB">
          <h3>participateAsMQB
            <sup class="sup-op" title="OWL Object Property">op</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#participateAsMQB</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>identifies a MQBearer participating on a value-assigning event</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subPropertyOf" title="The subject is a subproperty of a property. Defined in The RDF Schema vocabulary (RDFS)">Sub Property Of</a>
        ...
        <div class="property entity" id="participateAsVA">
          <h3>participateAsVA
            <sup class="sup-op" title="OWL Object Property">op</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#participateAsVA</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>identifies a ValuseAssigner participating on a value-assigning event</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subPropertyOf" title="The subject is a subproperty of a property. Defined in The RDF Schema vocabulary (RDFS)">Sub Property Of</a>
      ...
      <div class="section" id="datatypeproperties">
        ...
        <div class="property entity" id="assignedValue">
          <h3>assignedValue
            <sup class="sup-dp" title="OWL Datatype Property">dp</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#assignedValue</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>maps a ValueAsgmt to MQuality's domain (quality structure)</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subPropertyOf" title="The subject is a subproperty of a property. Defined in The RDF Schema vocabulary (RDFS)">Sub Property Of</a>
        ...
        <div class="property entity" id="endTime">
          <h3>endTime
            <sup class="sup-dp" title="OWL Datatype Property">dp</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#endTime</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>maps a AsgnEvent to the ending time of a value-assigning event</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subPropertyOf" title="The subject is a subproperty of a property. Defined in The RDF Schema vocabulary (RDFS)">Sub Property Of</a>
        ...
        <div class="property entity" id="resultTime">
          <h3>resultTime
            <sup class="sup-dp" title="OWL Datatype Property">dp</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#resultTime</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>maps a ValueAsgmt to the instant of time when a value was assigned to a MQuality</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subPropertyOf" title="The subject is a subproperty of a property. Defined in The RDF Schema vocabulary (RDFS)">Sub Property Of</a>
        ...
        <div class="property entity" id="sresultTime">
          <h3>sresultTime
            <sup class="sup-dp" title="OWL Datatype Property">dp</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#sresultTime</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>maps a CValueAsgmt to the starting instant of the ValueAsgmt aggregation</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subPropertyOf" title="The subject is a subproperty of a property. Defined in The RDF Schema vocabulary (RDFS)">Sub Property Of</a>
        ...
        <div class="property entity" id="startTime">
          <h3>startTime
            <sup class="sup-dp" title="OWL Datatype Property">dp</sup>
          </h3>
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>https://purl.org/s2c2/qvas#startTime</code>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td><p>maps a AsgnEvent to the starting time of a value-assigning event</p></td>
            </tr>
            <tr>
              <th>
                <a class="hover_property" href="http://www.w3.org/2000/01/rdf-schema#subPropertyOf" title="The subject is a subproperty of a property. Defined in The RDF Schema vocabulary (RDFS)">Sub Property Of</a>
      ...
      <div class="section" id="annotationproperties">
        ...
        <div class="property entity" id="isRuleEnabled">
          <h3>is rule enabled
          ...
          <table>
            <tr>
              <th>IRI</th>
              <td>
                <code>http://swrl.stanford.edu/ontologies/3.3/swrla.owl#isRuleEnabled</code>
              </td>
            </tr>
          </table>
        </div>
    ...
    <div id="toc">
      ...
      <ul class="first">
        ...
        <li>
          ...
          <ul class="second">
            <li>
              <a href="#AAsgnEvent">AAsgnEvent</a>
            </li>
            <li>
              <a href="#AValueAsgmt">AValueAsgmt</a>
            </li>
            <li>
              <a href="#AsgnEvent">AsgnEvent</a>
            </li>
            <li>
              <a href="#CAsgnEvent">CAsgnEvent</a>
            </li>
            <li>
            ...
            <li>
              <a href="#DomainQuality">DomainQuality</a>
            </li>
            <li>
              <a href="#MQBearer">MQBearer</a>
            </li>
            <li>
            ...
            <li>
              <a href="#ValueAssigner">ValueAssigner</a>
            </li>
          </ul>
        </li>
        <li>
          ...
          <ul class="second">
            <li>
              <a href="#describes">describes</a>
            </li>
            <li>
              <a href="#hasAEvent">hasAEvent</a>
            </li>
            <li>
              <a href="#hasVAsgmt">hasVAsgmt</a>
            </li>
            <li>
              <a href="#holdsValueFor">holdsValueFor</a>
            </li>
            <li>
              <a href="#isAssignedBy">isAssignedBy</a>
            </li>
            <li>
              <a href="#isResultOf">isResultOf</a>
            </li>
            <li>
              <a href="#participateAsMQB">participateAsMQB</a>
            </li>
            <li>
              <a href="#participateAsVA">participateAsVA</a>
            </li>
          </ul>
        </li>
        <li>
          ...
          <ul class="second">
            <li>
              <a href="#assignedValue">assignedValue</a>
            </li>
            <li>
              <a href="#endTime">endTime</a>
            </li>
            <li>
              <a href="#resultTime">resultTime</a>
            </li>
            <li>
              <a href="#sresultTime">sresultTime</a>
            </li>
            <li>
        ...
        <li>
          ...
          <ul class="second">
            <li>
              <a href="#isRuleEnabled">is rule enabled</a>
            </li>
          </ul>
        </li>
        <li>
