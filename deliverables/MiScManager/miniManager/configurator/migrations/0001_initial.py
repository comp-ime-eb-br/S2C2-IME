    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('militaryperson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='militaryScenarioConf.militaryperson')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('check_position', models.CharField(blank=True, max_length=1, null=True)),
                ('position_node', models.CharField(blank=True, max_length=30, null=True)),
                ('x_min', models.FloatField(blank=True, max_length=30, null=True)),
                ('x_max', models.FloatField(blank=True, max_length=30, null=True)),
                ('y_min', models.FloatField(blank=True, max_length=30, null=True)),
                ('y_max', models.FloatField(blank=True, max_length=30, null=True)),
                ('range', models.FloatField(blank=True, max_length=30, null=True)),
                ('antenna_gain', models.FloatField(blank=True, max_length=30, null=True)),
                ('node', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='configurator.node')),
            ],
            options={
                'db_table': 'Station',
